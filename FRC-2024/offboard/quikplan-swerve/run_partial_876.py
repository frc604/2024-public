...
def plan_8(quiet):
    ...
    qp.add_waypoint(
        PICKUP8,
        10,
        intermediate_constraints=[AngularConstraint(PICKUP8), YConstraint(PICKUP8)],
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/876-8")

    # Plot
    field.plot_traj(robot, traj, "partial/876-8.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/876-8.gif", save_gif=False)
...
def plan_8s7(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/876-8s7")

    # Plot
    field.plot_traj(robot, traj, "partial/876-8s7.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/876-8s7.gif", save_gif=False)
...
def plan_87(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/876-87")

    # Plot
    field.plot_traj(robot, traj, "partial/876-87.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/876-87.gif", save_gif=False)
...
def plan_7s6(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/876-7s6")

    # Plot
    field.plot_traj(robot, traj, "partial/876-7s6.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/876-7s6.gif", save_gif=False)
...
def plan_76(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/876-76")

    # Plot
    field.plot_traj(robot, traj, "partial/876-76.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/876-76.gif", save_gif=False)
...
def plan_6s(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/876-6s")

    # Plot
    field.plot_traj(robot, traj, "partial/876-6s.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/876-6s.gif", save_gif=False)
