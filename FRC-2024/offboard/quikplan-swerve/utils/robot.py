...
G = 9.81  # m/s/s
MODULE_X_DIST = in2m(12.125)  # m
MODULE_Y_DIST = in2m(12.125)  # m


class Robot(object):
    def __init__(self, MAX_RPM=3500, MAX_TORQUE=0.7):
        # Geometry
        self.WIDTH = in2m(36.0)  # m
        self.LENGTH = in2m(36.0)  # m
        self.GEOMETRY = [
            [
