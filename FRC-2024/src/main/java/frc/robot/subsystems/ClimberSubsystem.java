...
public class ClimberSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("Climber: Current Pos (rads)", m_motor.getSensorPosition());
    SmartDashboard.putNumber("Climber: Target Pos (rads)", m_motor.getClosedLoopReference());
