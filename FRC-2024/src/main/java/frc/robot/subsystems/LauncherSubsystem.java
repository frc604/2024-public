...
public class LauncherSubsystem extends SubsystemBase {
  public final DigitalInput m_beamBreak = new DigitalInput(Constants.Launcher.beamBreakPort);
  ...
  public double setLinearLaunchVelocity(double metersPerSecond) {
    ...
    final double radsPerSec =
        (metersPerSecond / Constants.Launcher.shotVelocity) * Constants.Launcher.launchVelocity;
  ...
  public void periodic() {
    ...
    SmartDashboard.putBoolean("Launcher: Beam Break", m_beamBreak.get());
  ...
  public void simulationPeriodic() {
    ...
    m_topWheelSim.update(TimedRobot.kDefaultPeriod);
    ...
    m_bottomWheelSim.update(TimedRobot.kDefaultPeriod);
    ...
    m_feedRollerSim.update(TimedRobot.kDefaultPeriod);
    ...
    m_redirectRollerSim.update(TimedRobot.kDefaultPeriod);
