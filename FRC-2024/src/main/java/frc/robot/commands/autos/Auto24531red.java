...
public class Auto24531red implements AutoCommand {
  private final QuikPlanSwervePartialTrajectoryReader m_2s4 =
      new QuikPlanSwervePartialTrajectoryReader("24531red-2s4.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_4s5 =
      new QuikPlanSwervePartialTrajectoryReader("24531red-4s5.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_45 =
      new QuikPlanSwervePartialTrajectoryReader("24531red-45.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_5s3s1s =
      new QuikPlanSwervePartialTrajectoryReader("24531red-5s3s1s.csv");
    ...
    m_command =
        new SequentialCommandGroup(
            ...
            new ConditionalCommand(
                new FollowQuikplan(m_4s5, swerve, intake, launcher, EndMode.IMMEDIATE),
                new FollowQuikplan(m_45, swerve, intake, launcher, EndMode.IMMEDIATE),
                () -> true),
