...
public class Auto25431red implements AutoCommand {
  private final QuikPlanSwervePartialTrajectoryReader m_2s5 =
      new QuikPlanSwervePartialTrajectoryReader("25431red-2s5.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_5s4 =
      new QuikPlanSwervePartialTrajectoryReader("25431red-5s4.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_54 =
      new QuikPlanSwervePartialTrajectoryReader("25431red-54.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_4s3s1s =
      new QuikPlanSwervePartialTrajectoryReader("25431red-4s3s1s.csv");
