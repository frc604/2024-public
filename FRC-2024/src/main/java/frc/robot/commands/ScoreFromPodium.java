...
public class ScoreFromPodium extends Command {
  private final LauncherSubsystem m_launcher;
  private boolean m_readyToShoot;

  public ScoreFromPodium(LauncherSubsystem launcher) {
    m_launcher = launcher;
  ...
  public void execute() {
    if (m_launcher.isAtAngle(
            Constants.Launcher.podiumLaunchAngle, Constants.Launcher.launchAngleTolerance)
