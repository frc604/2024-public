...
public class PhoenixUtil {
  ...
  public static boolean retryUntilSuccess(
  ...
  public static boolean isEqual(MotionMagicConfigs a, MotionMagicConfigs b) {
    return MathUtils.epsilonEquals(a.MotionMagicCruiseVelocity, b.MotionMagicCruiseVelocity, kEps)
        && MathUtils.epsilonEquals(a.MotionMagicAcceleration, b.MotionMagicAcceleration, kEps)
        && MathUtils.epsilonEquals(a.MotionMagicJerk, b.MotionMagicJerk, kEps)
        && MathUtils.epsilonEquals(a.MotionMagicExpo_kV, b.MotionMagicExpo_kV, kEps)
        && MathUtils.epsilonEquals(a.MotionMagicExpo_kA, b.MotionMagicExpo_kA, kEps);
  }
  ...
  public static boolean isEqual(TorqueCurrentConfigs a, TorqueCurrentConfigs b) {
    return MathUtils.epsilonEquals(a.PeakForwardTorqueCurrent, b.PeakForwardTorqueCurrent, kEps)
        && MathUtils.epsilonEquals(a.PeakReverseTorqueCurrent, b.PeakReverseTorqueCurrent, kEps)
        && MathUtils.epsilonEquals(a.TorqueNeutralDeadband, b.TorqueNeutralDeadband, kEps);
  }
}
