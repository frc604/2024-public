...
public class QuixTalonFXTest implements AutoCloseable {
  ...
  //         kCANDelayTime, controller.percentOutputSignal(),
  // controller_follower.percentOutputSignal());
  ...
  //     QuixStatusSignal.waitForAll(
  //         kCANDelayTime,
  //         motorWithLimit.percentOutputSignal(),
  //         motorWithoutLimit.percentOutputSignal());
