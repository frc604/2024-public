...
def plan_1s4(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1456red-1s4")

    # Plot
    field.plot_traj(robot, traj, "partial/1456red-1s4.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1456red-1s4.gif", save_gif=False)
...
def plan_4s5(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1456red-4s5")

    # Plot
    field.plot_traj(robot, traj, "partial/1456red-4s5.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1456red-4s5.gif", save_gif=False)
...
def plan_45(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1456red-45")

    # Plot
    field.plot_traj(robot, traj, "partial/1456red-45.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1456red-45.gif", save_gif=False)
...
def plan_5s6(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1456red-5s6")

    # Plot
    field.plot_traj(robot, traj, "partial/1456red-5s6.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1456red-5s6.gif", save_gif=False)
...
def plan_56(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1456red-56")

    # Plot
    field.plot_traj(robot, traj, "partial/1456red-56.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1456red-56.gif", save_gif=False)
...
def plan_6s(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1456red-6s")

    # Plot
    field.plot_traj(robot, traj, "partial/1456red-6s.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1456red-6s.gif", save_gif=False)
