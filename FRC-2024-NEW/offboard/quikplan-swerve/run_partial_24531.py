...
def plan_2s4(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/24531-2s4")

    # Plot
    field.plot_traj(robot, traj, "partial/24531-2s4.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/24531-2s4.gif", save_gif=False)
...
def plan_4s5(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/24531-4s5")

    # Plot
    field.plot_traj(robot, traj, "partial/24531-4s5.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/24531-4s5.gif", save_gif=False)
...
def plan_45(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/24531-45")

    # Plot
    field.plot_traj(robot, traj, "partial/24531-45.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/24531-45.gif", save_gif=False)
...
def plan_5s3s1s(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/24531-5s3s1s")

    # Plot
    field.plot_traj(robot, traj, "partial/24531-5s3s1s.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/24531-5s3s1s.gif", save_gif=False)
