...
def plan(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "876")

    # Plot
    field.plot_traj(robot, traj, "876.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "876.gif", save_gif=False)
