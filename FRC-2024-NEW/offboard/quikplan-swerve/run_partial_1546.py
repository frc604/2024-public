...
def plan_1s5(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1546-1s5")

    # Plot
    field.plot_traj(robot, traj, "partial/1546-1s5.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1546-1s5.gif", save_gif=False)
...
def plan_5s4(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1546-5s4")

    # Plot
    field.plot_traj(robot, traj, "partial/1546-5s4.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1546-5s4.gif", save_gif=False)
...
def plan_54(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1546-54")

    # Plot
    field.plot_traj(robot, traj, "partial/1546-54.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1546-54.gif", save_gif=False)
...
def plan_4s6(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1546-4s6")

    # Plot
    field.plot_traj(robot, traj, "partial/1546-4s6.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1546-4s6.gif", save_gif=False)
...
def plan_46(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1546-46")

    # Plot
    field.plot_traj(robot, traj, "partial/1546-46.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1546-46.gif", save_gif=False)
...
def plan_6s(quiet):
    ...
    # Plan the trajectory
    traj = qp.plan()
    write_to_csv(traj, "partial/1546-6s")

    # Plot
    field.plot_traj(robot, traj, "partial/1546-6s.png", save=True, quiet=quiet)

    if not quiet:
        # Animate
        field.anim_traj(robot, traj, "partial/1546-6s.gif", save_gif=False)
