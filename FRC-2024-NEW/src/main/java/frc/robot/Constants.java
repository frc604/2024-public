...
public class Constants {
  ...
  public static final boolean resimWithTiming = false; // Resim as fast as possible
  ...
  public static final class Swerve { // TODO: updated with real values
    ...
    public static final SimpleMotorFeedforward driveVelocityFeedforward =
        new SimpleMotorFeedforward(0.0, 2.6, 0.0);
  ...
  public static final class Intake {
    ...
    public static final double intakeDeployAngle = Math.toRadians(-49); // rad
  ...
  public static final class Launcher {
    ...
    public static final double bootAbsPositionOffset = Units.degreesToRadians(0.0);
    ...
    public static final double scaleStartDistance = Units.feetToMeters(5);
    public static final double scaleEndDistance = Units.feetToMeters(15);

    public static final double defaultShotVelocity = 20; // m/s
    public static final double minShotVelocity = 15; // m/s
