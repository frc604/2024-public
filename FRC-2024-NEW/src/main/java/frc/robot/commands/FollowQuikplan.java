...
public class FollowQuikplan extends Command {
  ...
  private boolean m_launcherOn = true;

  private final EndMode m_endMode;
  private final boolean m_skipLauncherStart;
  ...
  public FollowQuikplan(
    ...
    this(reader, swerve, intake, launcher, EndMode.IMMEDIATE, false);
  }
  ...
  public FollowQuikplan(
      ...
      IntakeSubsystem intake,
      LauncherSubsystem launcher,
      boolean skipLauncherStart) {
    this(reader, swerve, intake, launcher, EndMode.IMMEDIATE, skipLauncherStart);
  }
  ...
  public FollowQuikplan(
      ...
      LauncherSubsystem launcher,
      EndMode endMode) {
    this(reader, swerve, intake, launcher, endMode, false);
  }
  ...
  public FollowQuikplan(
    ...
    m_intake = intake;
    m_endMode = endMode;
    m_skipLauncherStart = skipLauncherStart;
  ...
  @Override
  public void execute() {
    m_launcher.setLaunchVelocity(m_launcherOn ? Constants.Launcher.launchVelocity : 0.0);

    if (!m_shootReady && !m_launcher.isAtAutoStartVelocity() & !m_skipLauncherStart) {
      m_startDelayTimer.reset();
    } else {
      m_shootReady = true;
    }
