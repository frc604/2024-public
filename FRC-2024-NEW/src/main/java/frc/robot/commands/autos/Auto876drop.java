...
public class Auto876drop implements AutoCommand {
  // Starting trajectory
  private final QuikPlanSwervePartialTrajectoryReader m_8 =
      new QuikPlanSwervePartialTrajectoryReader("876drop-8.csv");

  // Recovery trajectories
  private final QuikPlanSwervePartialTrajectoryReader m_87 =
      new QuikPlanSwervePartialTrajectoryReader("876drop-87.csv");
  ...
  // Score to pickup
  private final QuikPlanSwervePartialTrajectoryReader m_s7 =
      new QuikPlanSwervePartialTrajectoryReader("876drop-s7.csv");
  ...
  public Auto876drop(
    ...
    m_command =
        new SequentialCommandGroup(
            new FollowQuikplan(m_8, swerve, intake, launcher, true),
            new ConditionalCommand(
                // Picked up 8
                new SequentialCommandGroup(
                    new FollowQuikplan(m_8s, swerve, intake, launcher, true),
                    new FollowQuikplan(m_s7, swerve, intake, launcher, true),
                    new ConditionalCommand(
                        // Picked up 7
                        new SequentialCommandGroup(
                ...
                // Missed 8
                new SequentialCommandGroup(
                    new FollowQuikplan(m_87, swerve, intake, launcher, true),
                    new ConditionalCommand(
                        // Picked up 7
                        new SequentialCommandGroup(
                            new FollowQuikplan(m_7s, swerve, intake, launcher, true),
  ...
  public ArrayList<QuikPlanSwervePartialTrajectoryReader> getPartialTrajectories() {
    return new ArrayList<>(
        Arrays.asList(m_8, m_87, m_76, m_60, m_8s, m_7s, m_6s, m_0s, m_s7, m_s6, m_s0));
  }
}
