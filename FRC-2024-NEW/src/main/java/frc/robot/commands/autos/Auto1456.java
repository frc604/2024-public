...
public class Auto1456 implements AutoCommand {
  private final QuikPlanSwervePartialTrajectoryReader m_1s4 =
      new QuikPlanSwervePartialTrajectoryReader("1456-1s4.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_45 =
      new QuikPlanSwervePartialTrajectoryReader("1456-45.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_4s5 =
      new QuikPlanSwervePartialTrajectoryReader("1456-4s5.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_5s6 =
      new QuikPlanSwervePartialTrajectoryReader("1456-5s6.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_56 =
      new QuikPlanSwervePartialTrajectoryReader("1456-56.csv");
  private final QuikPlanSwervePartialTrajectoryReader m_6s =
      new QuikPlanSwervePartialTrajectoryReader("1456-6s.csv");
